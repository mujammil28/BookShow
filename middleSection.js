      ...
      const modal = `
        ...
        <div class="details">
          ...
          <div class="add-comment">
            <h3 class="add-comm-header">Fill Details</h3>
            <div class="comment-input-container">
              <input type="text" class="nameInput" size="30" placeholder="Name">
              <input type="text" class="nameInput" size="30" placeholder="Emai-Id">
              <input type="text" class="nameInput" size="30" placeholder="Mob-No">
              <br>
           
              <br>
              <button class="sub-comment-btn" id="${btnId}" type="button" onClick="alert('Your ticket booked..')">Book Ticket</button>
            </div>
          </div>
      `;
  ...
  arr.slice(0, 20).forEach((movie) => {
    fetchLikes().then((res) => {
      ...
      <article id="${arr.indexOf(movie)}">
        ...
        <button class="comment-btn" type="button" id="${arr.indexOf(movie)}">Book Show</button>
